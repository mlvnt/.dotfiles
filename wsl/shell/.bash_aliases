...
alias dots="sudo rm -rfv ~./.dotfiles && git pull /mnt/d/Workspace/General/Tech/Reference/OSs/Unix/dotfiles/.dotfiles/ ~/.dotfiles && cd ~/.dotfiles && sudo dos2unix ./.* ./*.* ./shell/.* ./shell/*.* ./editors/.* ./editors/*.* ./git/.* ./git/*.* ./bin/* && sca && cd ~/"
alias v="vim"
alias c='clear'
alias rm="rm -v"
