...
alias keepass="cat /mnt/d/shared/mobile/config/notes/p/keepass/k.txt | cmd.exe /c clip && cmds 'D:\apps\suites\portableapps.com\PortableApps\KeePassProPortable' KeePassProPortable.exe"
