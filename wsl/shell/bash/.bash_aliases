...
alias kitchen="o 'D:\Workspace\General\Essential\Lists\Kitchen.xlsx'"
...
alias keepass="cat /mnt/d/Workspace/Shared/mobile/config/apps/notes/p/K.txt | cmd.exe /c clip && cmd.exe /c start /D 'D:\Workspace\Portable Apps\PortableApps.com\PortableApps\KeePassProPortable' KeePassProPortable.exe"
